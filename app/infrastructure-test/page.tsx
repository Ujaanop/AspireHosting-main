          ...
          <div key={loc.id} className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {loc.nodes.map((node, idx) => (
                ...
                >
                  {node.comingSoon && (
                    <div className="absolute top-3 right-3 text-xs px-2 py-1 rounded-full bg-yellow-400/20 text-yellow-700 dark:bg-yellow-500/20 dark:text-yellow-300 border border-yellow-400/40">
                      Coming Soon
                    </div>
                  )}
                  <div className="flex items-center justify-between mb-3">
                    ...
                    {node.ownedHardware && (
                      <span className="text-xs px-2 py-1 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400">Owned Hardware</span>
                    )}
                    {node.waterCooled && (
                      <span className="text-xs px-2 py-1 rounded-full bg-cyan-500/10 text-cyan-600 dark:text-cyan-400">Water Cooled</span>
                    )}
                  </div>
