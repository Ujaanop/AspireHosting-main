...
export default function CookieConsent() {
  ...
  const [cookiePreferences, setCookiePreferences] = useState<CookiePreferences>({
    ...
    preferences: false, // For language and theme - starts false
  });
  ...
  const handleRejectAll = () => {
    const minimal = {
      necessary: true,
      preferences: false, // Don't save language/theme
    };
                    ...
                    <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-gray-200/50 dark:border-white/10 rounded-lg p-4 hover:hover-gradient hover:border-secondary transition-all duration-300">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          ...
                          className={`w-12 h-6 rounded-full flex items-center px-1 transition-all duration-300 shadow-lg ${
