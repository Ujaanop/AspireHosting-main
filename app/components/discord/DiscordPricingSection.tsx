...
const config = discordConfig as unknown as DiscordConfig
                  ...
                  <div className="mt-6">
                    <div className="flex justify-center mb-4">
                      <DiscountedPrice
                        ...
                        planType={selectedPlanType.includes("budget") ? "budget" : selectedPlanType.includes("premium") ? "premium" : "budget"}
                    ...
                    <ComingSoonButton
                      ...
                      className="orbitron-font w-full bg-green-600 hover:bg-green-700 dark:bg-green-600/20 text-white dark:text-green-400 px-6 py-3"
                    >
                      {t('common.orderNow')}
                    </ComingSoonButton>
                  </div>
